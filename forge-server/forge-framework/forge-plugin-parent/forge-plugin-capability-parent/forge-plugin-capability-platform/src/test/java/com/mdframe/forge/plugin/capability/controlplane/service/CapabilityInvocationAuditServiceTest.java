...
class CapabilityInvocationAuditServiceTest {
    ...
    void shouldPersistOnlySafeMetadataThroughIdempotentInsert() {
        ...
        CapabilityInvocationAuditEvent event = new CapabilityInvocationAuditEvent(
                ...
                CapabilityResultStatus.SUCCESS, "OK", null, null, null, null, "trace-1", -10L);
    ...
    void shouldAcceptUserAuditWithoutBoundServiceAccount() {
        ...
        CapabilityInvocationAuditEvent event = new CapabilityInvocationAuditEvent(
                ...
                CapabilityResultStatus.SUCCESS, "SUCCESS", null, null, null, null, null, 10L);
    ...
    void shouldRejectRawExceptionOrSecretInStableErrorCode() {
        ...
        CapabilityInvocationAuditEvent event = new CapabilityInvocationAuditEvent(
                ...
                "secret=fcp_leaked_value", null, null, null, "trace-1", 10L);
    ...
    void shouldInsertReservationThenUpdateFinalResultByTrustedIdentity() {
        ...
        CapabilityInvocationAuditEvent event = new CapabilityInvocationAuditEvent(
                "request-1", 1L, "client_a", 2L, "system.user.search", "1.0.0",
                CapabilityActorType.USER, 8L, 3L, 4L,
                CapabilityResultStatus.ERROR, "EXECUTION_PENDING", null, null, null, null, null, 0L);
    ...
    void shouldEstablishAndRestoreTrustedTenantContextForFailureAudit() {
        ...
        CapabilityInvocationAuditEvent event = new CapabilityInvocationAuditEvent(
                ...
                CapabilityActorType.USER, 8L, null, 4L,
                CapabilityResultStatus.ERROR, "FAILED", "FORBIDDEN",
                "AUTHORIZATION", "当前调用方无权执行该能力", null, null, 10L);
